...
import { register as registerUser, selectAuthLoading } from "../../app/slices/authSlice.js";
import { createRegisterSchema } from "../../utils/schemas/auth.schemas.js";
    ...
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          <Input label={t.auth.name} name="name" type="text" register={register} error={errors.name} disabled={isLoading} required />
          <Input label={t.auth.email} name="email" type="email" register={register} error={errors.email} autoComplete="email" disabled={isLoading} required />
          <Input label={t.auth.password} name="password" type="password" register={register} error={errors.password} autoComplete="new-password" disabled={isLoading} required />
          <Input
