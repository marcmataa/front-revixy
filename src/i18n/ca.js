...
export default {
  auth: {
    ...
    shopifyConnecting: "Connectant la teva botiga Shopify...",
    shopifyCallbackError: "No s'ha pogut verificar la connexió amb Shopify. Torna-ho a intentar.",
    shopifyOAuthFailed: "L'autorització de Shopify ha fallat. Torna-ho a intentar.",
  },
  dashboard: {
  ...
  onboarding: {
    ...
    step2of3: "Pas 2 de 3",
    step3of3: "Pas 3 de 3",
    shopifyPlaceholder: "la-teva-botiga.myshopify.com",
    shopifyDomainError: "Format invàlid. Exemple: la-teva-botiga.myshopify.com",
    connectShopifyError: "Error en connectar amb Shopify. Torna-ho a intentar.",
    skipForNow: "Ometre per ara",
    metaComingSoon: "Meta Ads estarà disponible aviat.",
    saveAndContinue: "Desar i continuar",
    saveError: "Error en desar la configuració. Torna-ho a intentar.",
    contributionMargin: "Marge de contribució (%)",
    executionMode: "Mode d'execució",
    strategy: "Estratègia",
    sector: "Sector",
    language: "Idioma",
    calculatorNoData: "Connecta Shopify per veure el teu benefici teòric",
    theoreticalProfit: "Benefici teòric",
    executionModes: {
  ...
  settings: {
    ...
    integrations: {
      ...
      disconnectComingSoon: "La desconnexió estarà disponible aviat.",
      disconnectTitle: "Desconnectar Shopify",
      disconnectWarning: "Aquesta acció eliminarà l'accés de Revixy a la teva botiga Shopify. Podràs reconnectar en qualsevol moment.",
      disconnectSuccess: "Shopify desconnectat correctament.",
      disconnectCancel: "Cancel·lar",
      disconnectConfirm: "Sí, desconnectar",
    },
    goals: {
  ...
  landing: {
    ...
    footer: {
      tagline: "IA per escalar el teu ecommerce sense friccions",
      productCol: "Producte",
      features: "Funcionalitats",
      pricing: "Preus",
      integrations: "Integracions",
      legalCol: "Legal i Contacte",
      privacy: "Privacitat",
      terms: "Termes",
      contact: "Contacte",
  ...
  integrations: {
    pageTitle: "Integracions",
    pageSubtitle: "Gestiona les connexions de la teva botiga amb plataformes externes.",
    connect: "Connectar",
    comingSoon: "Pròximament",
    shopifyDescription: "Sincronitza comandes, productes i inventari de la teva botiga Shopify.",
    metaDescription: "Analitza el rendiment de les teves campanyes de Meta Ads.",
  },
};
