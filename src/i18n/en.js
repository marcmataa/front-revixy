...
export default {
  auth: {
    ...
    shopifyConnecting: "Connecting your Shopify store...",
    shopifyCallbackError: "Could not verify Shopify connection. Please try again.",
    shopifyOAuthFailed: "Shopify authorization failed. Please try again.",
  },
  dashboard: {
    title: "Dashboard",
  ...
  onboarding: {
    ...
    shopifyDomainError: "Invalid format. Example: your-store.myshopify.com",
    connectShopifyError: "Failed to connect with Shopify. Please try again.",
    skipForNow: "Skip for now",
    metaComingSoon: "Meta Ads will be available soon.",
    ...
    sector: "Sector",
    language: "Language",
    calculatorNoData: "Connect Shopify to see your theoretical profit",
  ...
  settings: {
    ...
    integrations: {
      ...
      disconnectComingSoon: "Disconnection will be available soon.",
      disconnectTitle: "Disconnect Shopify",
      disconnectWarning: "This will remove Revixy's access to your Shopify store. You can reconnect at any time.",
      disconnectSuccess: "Shopify disconnected successfully.",
  ...
  landing: {
    ...
    footer: {
      tagline: "AI to scale your ecommerce without friction",
      productCol: "Product",
      features: "Features",
      pricing: "Pricing",
      integrations: "Integrations",
      legalCol: "Legal & Contact",
      privacy: "Privacy",
      terms: "Terms",
      contact: "Contact",
  ...
  integrations: {
    ...
    pageSubtitle: "Manage your store's connections with external platforms.",
    connect: "Connect",
    comingSoon: "Coming soon",
    shopifyDescription: "Sync orders, products and inventory from your Shopify store.",
    metaDescription: "Analyze the performance of your Meta Ads campaigns.",
  },
};
